...
function buildOtherFilters(
  filters: ReceiptExcelFiltersState,
  excludeKey: FilterKey
): ReceiptsFilterOtherFilter[] {
                      ...
                      <CommandItem
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-sm text-foreground">
                            {props.filterKey === "receiptStatus"
                              ? getReceiptStatusLabel(key, t)
                              : key}
                          </span>
                        </div>
...
export function ReceiptsTable({
  ...
  const setStr = (key: "receiptCode", values: string[]) => {
      ...
      <table className="w-full">
        <thead className="bg-muted/50 border-b border-border">
          <tr>
            ...
            <th className="px-4 py-3 text-left text-xs font-medium text-muted-foreground uppercase tracking-wider">
              {String(t("reception.sampleReception.table.processing.deadline"))}
            </th>

            <th className="px-4 py-3 text-left text-xs font-medium text-muted-foreground uppercase tracking-wider">
              {activeTab === "processing"
                ? String(t("reception.sampleReception.table.processing.notes"))
                : String(
                ...
                <td className="px-4 py-4">
                  {activeTab === "processing" ? (
                    ...
                    <span className="text-sm text-muted-foreground">
                      {String(t("reception.sampleReception.tracking.none"))}
                    </span>
                  )}
                </td>
