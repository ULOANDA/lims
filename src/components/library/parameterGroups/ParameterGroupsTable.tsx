...
import type {
  ParameterGroup,
  ParameterGroupsFilterFrom,
  ParameterGroupsFilterOtherFilter,
} from "@/api/library";
...
function formatCurrency(value: number, locale: string) {
  return new Intl.NumberFormat(locale, { style: "currency", currency: "VND" }).format(
    value
  );
}
...
function buildOtherFilters(
  filters: ParameterGroupsExcelFiltersState,
