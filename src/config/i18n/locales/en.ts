export default {
  ...
  labManager: {
    dashboard: {
      ...
      searchPlaceholder:
        "Search by receipt, sample, parameter, tech, client...",
      tabs: {
        pending: "Pending Approval",
        final: "Final Output",
      },
  ...
  inventory: {
    dashboard: {
      ...
      alerts: {
        chemicalExpiry:
          "<strong class='font-bold text-destructive'>{{count}}</strong> chemicals expiring in {{days}} days!",
        chemicalWarning:
          "<strong class='font-bold text-orange-600'>{{count}}</strong> chemicals to watch in {{days}} days.",
        equipmentOverdue:
          "<strong class='font-bold text-destructive'>{{count}}</strong> equipment overdue for calibration!",
  ...
  handover: {
    ...
    document: {
      ...
      close: "Close",
      preview:
        "The record is made in 02 copies with equal legal validity, each party keeps 01 copy.",
    },
    modal: {
